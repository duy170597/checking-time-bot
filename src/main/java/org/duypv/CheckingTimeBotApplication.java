...
public class CheckingTimeBotApplication {
	private static final Logger log = LoggerFactory.getLogger(CheckingTimeBotApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(CheckingTimeBotApplication.class, args);
